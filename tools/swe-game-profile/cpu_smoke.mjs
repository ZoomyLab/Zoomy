#!/usr/bin/env node
/**
 * CPU-path smoke test for the SWE game after the codegen rewire.
 *
...
const URL = `${BASE}/apps/swe-game/index.html?gpu=0&profile=1`;
...
console.log(ok ? "CPU SMOKE: PASS" : "CPU SMOKE: FAIL");
process.exit(ok ? 0 : 1);
