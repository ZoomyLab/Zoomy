...
class VAMPoisson(Model):
    def __init__(
        ...
        dimension=1,
        fields=['p0', 'p1'],
        aux_variables=['dp0dx', 'ddp0dxx', 'dp1dx', 'ddp1dxx', 'd4p0dx4', 'd4p1dx4', 'h', 'dbdx', 'ddbdxx', 'dhdx', 'ddhdxx', 'u0', 'du0dx', 'w0', 'w1', 'u1', 'du1dx', 'dt'],
        parameters={},
        _default_parameters={"g": 9.81},
        settings={},
        settings_default={},
...
def test_vam_1d():
    ...
    mesh = LSQMesh.create_1d((-1.5, 1.5), 60, lsq_degree=2)
